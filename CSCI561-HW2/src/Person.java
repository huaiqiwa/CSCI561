...
public class Person {
	...
	private int estDistTime;//the estimated time distance it is from destination("Noah")
	private int estDistRisk;//the estimated risk distance it is from destination("Noah")
	...
	public void setEstDistTime(int time) {
		estDistTime = time;
	}
	
	public int getEstDistTime() {
		return estDistTime;
	}
	
	public void setEstDistRisk(int risk) {
		estDistRisk = risk;
	}
	
	public int getEstDistRisk() {
		return estDistRisk;
	}
	
	public int peekEstTime() {
		return estDistTime + distToTime;
	}
	
	public int peekEstRisk() {
		return estDistRisk + distToRisk;
	}
